...
class AgentTrace(Base):
    ...
    requested_model: Mapped[Optional[str]] = mapped_column(String(120))
    actual_model: Mapped[Optional[str]] = mapped_column(String(120))
    response_id: Mapped[Optional[str]] = mapped_column(String(160))
    request_id: Mapped[Optional[str]] = mapped_column(String(160))
    prompt_tokens: Mapped[Optional[int]] = mapped_column(Integer)
    completion_tokens: Mapped[Optional[int]] = mapped_column(Integer)
    total_tokens: Mapped[Optional[int]] = mapped_column(Integer)
    transport_retry_count: Mapped[int] = mapped_column(
...
class ScoringRun(Base):
    ...
    prompt_template_id: Mapped[str] = mapped_column(String(120))
    prompt_version: Mapped[str] = mapped_column(String(40))
    final_scorer_contract_sha256: Mapped[Optional[str]] = mapped_column(String(64))
    repair_used: Mapped[bool] = mapped_column(Boolean, default=False)
