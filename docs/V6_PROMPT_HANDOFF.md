...
- `v6.1.1`：`e336fd8dc6247d0f0dba3c3ce9924c403ee3cdd0f2a866325106aa3ff55418e6`
...
每个正常探查回合只选择一个主要焦点，可柔性澄清情境、核查依据、深入理由或反例、探索相关方与权衡、具体化行动，或探查调整条件；不得固定排序、泄露动作名、给答题示例或高分模板。
