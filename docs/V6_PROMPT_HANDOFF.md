...
版本：`natural_interviewer_v6.0.3`、`natural_final_scorer_v6.1.0`
...
### `natural_interviewer_v6.0.3` 的系统约束
...
若对方完整一轮只表达“不知道”“不清楚”“不确定”“没想好”等明确不确定，先简短接纳，再结合已有逐字稿换成一个低压力的开放问题。不要要求凑字数、复述不确定原句、提供答案示例或二选一，也不得仅因这句不确定就结束。
